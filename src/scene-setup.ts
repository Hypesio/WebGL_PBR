...
export function setupScenePointLight(): PointLight[] {
    ...
    lights[0].setIntensity(20.0);
    lights.push(new PointLight());
    lights[1].positionWS = vec3.set(vec3.create(),-3, -4, -6); 
    lights[1].setIntensity(20.0);
    lights.push(new PointLight());
    lights[2].positionWS = vec3.set(vec3.create(),-5, 2, -6); 
    lights[2].setIntensity(20.0);
    lights.push(new PointLight());
    lights[3].positionWS = vec3.set(vec3.create(),5, 2, -5); 
    lights[3].setIntensity(20.0);
